...
namespace Synthborn.Combat.Health
{
    ...
    public class EntityHealth : MonoBehaviour, IDamageable
    {
        ...
        /// <summary>Fired when this entity dies. Subscribers receive this EntityHealth instance.</summary>
        public event System.Action<EntityHealth> OnDeath;
        ...
        /// <summary>Force-kill the entity immediately (used by Exploder self-destruct).</summary>
